...
mask applies. So this is a speed-only optimization gated on numeric identity, not on
a val score -- it computes the same numbers as stock sliding attention, only faster.
